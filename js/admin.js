...
(function () {
  ...
  function gate() {
    ...
    var stored = localStorage.getItem(PASSCODE_KEY);
    if (!stored) {
      msg.textContent = "Première visite : choisissez un mot de passe pour protéger cette page (protection légère, à usage dissuasif seulement).";
